...
namespace ERPLibrary.AjaxServerSide
{
    /// <summary>
    ...
    {
        public DTResult<T> DTResult { set; get; }
        public  DTRow DTRow { set; get; }
        public DTParameters DTParameters { set; get; }
        public DTOrder DTOrder { set; get; }
        public DTOrderDir DTOrderDir { set; get; }
        public DTSearch DTSerach { set; get; }
